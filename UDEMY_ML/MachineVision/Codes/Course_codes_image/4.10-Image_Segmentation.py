...
image = cv2.imread('/Users/samuelsonawane/Downloads/UDEMY_ML/MachineVision/Codes/Course_codes_image/Image_9.jpg')
...
contours, hierarchy ,_= cv2.findContours(canny, cv2.RETR_LIST, cv2.CHAIN_APPROX_NONE)
