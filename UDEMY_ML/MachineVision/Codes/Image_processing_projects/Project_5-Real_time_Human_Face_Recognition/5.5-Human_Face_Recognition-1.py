...
#/Users/samuelsonawane/Downloads/UDEMY_ML/MachineVision/Codes/Image_processing_projects/Project_5-Real_time_Human_Face_Recognition
...
while True:
	...
	if face_detector(capturing) is not None:
		...
		path = '/Users/samuelsonawane/Downloads/UDEMY_ML/MachineVision/Codes/Image_processing_projects/Project_5-Real_time_Human_Face_Recognition/human_faces/' + str(face_count) + '.jpg'
