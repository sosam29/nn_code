...
path = '/Users/samuelsonawane/Downloads/UDEMY_ML/MachineVision/Codes/Image_processing_projects/Project_5-Real_time_Human_Face_Recognition/Trainingfaces/'
...
#face_recognizer = cv2.face.EigenFaceRecognizer_create() # zero
#face_recognizer = cv2.face.FisherFaceRecognizer_create()
#face_recognizer = cv2.face.StandardCollector_create()
...
face_detect = cv2.CascadeClassifier('/Users/samuelsonawane/Downloads/UDEMY_ML/MachineVision/Codes/Image_processing_projects/Project_5-Real_time_Human_Face_Recognition/haarcascade_frontalface_default.xml')
...
while True:
	...
	try:
		...
		if score > 70:
			...
			cv2.putText(image, "Welcome SAM", (210, 40), cv2.FONT_HERSHEY_COMPLEX, 1, (0,255,255), 2)
			
			# Display Real-time Face Recognition using imshow built-in function
			cv2.imshow('Real-time Face Recognition', image)
		
		else:
			cv2.putText(image, "This is NOT SAM", (150, 100), cv2.FONT_HERSHEY_COMPLEX, 1, (0,0,255), 3)
			cv2.imshow('Real-time Face Recognition', image)
