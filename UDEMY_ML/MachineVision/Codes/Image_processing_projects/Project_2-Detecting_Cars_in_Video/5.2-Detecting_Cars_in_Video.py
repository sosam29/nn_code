...
cars_detect = cv2.CascadeClassifier('/Users/samuelsonawane/Downloads/UDEMY_ML/MachineVision/Codes/Image_processing_projects/Project_1-Project_2-Detecting_Cars_in_Video/haarcascade_car.xml')

# Initializing video capturing object for video file 
capture = cv2.VideoCapture('/Users/samuelsonawane/Downloads/UDEMY_ML/MachineVision/Codes/Image_processing_projects/Project_2-Detecting_Cars_in_Video/cars.avi')
...
while capture.isOpened():
    ...
    cars_detected = cars_detect.detectMultiScale(gray, 1.4, 3)
