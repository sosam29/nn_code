...
face_detect = cv2.CascadeClassifier('/Users/samuelsonawane/Downloads/UDEMY_ML/MachineVision/Codes/Image_processing_projects/Project_1-Human_Face_Eyes_Noise_Detection/haarcascade_frontalface_alt.xml')

# Load human eyes cascade file using cv2.CascadeClassifier built-in function
# cv2.CascadeClassifier([filename]) 
eyes_detect = cv2.CascadeClassifier('/Users/samuelsonawane/Downloads/UDEMY_ML/MachineVision/Codes/Image_processing_projects/Project_1-Human_Face_Eyes_Noise_Detection/haarcascade_eye.xml')

# Load human noise cascade file using cv2.CascadeClassifier built-in function
# cv2.CascadeClassifier([filename]) 
noise_detect = cv2.CascadeClassifier('/Users/samuelsonawane/Downloads/UDEMY_ML/MachineVision/Codes/Image_processing_projects/Project_1-Human_Face_Eyes_Noise_Detection/haarcascade_mcs_nose.xml')
